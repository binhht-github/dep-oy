...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().formLogin().disable().httpBasic().disable().exceptionHandling()
				.authenticationEntryPoint(unauthorizedHandler).and().sessionManagement()
				.sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().authorizeRequests()
				.antMatchers("/", "/error", "/favicon.ico", "/**/*.png", "/**/*.gif", "/**/*.svg", "/**/*.jpg",
						"/**/*.html", "/**/*.css", "/**/*.js", "/auth/google/**", "/oauth2/callback/google/**",
						"/api/v1/user/auth/**", "/api/v1/schedule-tDime/**", "/api/v1/accounts/**", "/api/v1/posts/**",
						"/api/v1/vouchers/**", "/api/v1/files/**", "/api/v1/booking/**", "/api/v1/booking/detail/**",
						"/api/v1/comment/**", "/api/v1/communes/**", "/api/v1/customers/**", "/api/v1/dentists/**",
						"/api/v1/districts/**", "/api/v1/likes/**", "/api/v1/provinces/**", "/api/v1/services/**",
						"/api/v1/schedule-time/**", "/api/v1/roles/**", "/v3/api-docs", "/swagger-resources/**",
						"/swagger-ui/**", "/manage/**", "/api/v1/report/**")
				.permitAll()

				.antMatchers("/api/v1/vouchers/**", "/api/v1/booking/**", "/api/v1/booking/detail/**",
						"/api/v1/comment/**", "/api/v1/customers/**", "/api/v1/dentists/**", "/api/v1/likes/**",
						"/api/v1/posts/**", "/api/v1/services/**")
